...
// export type OperationSupporterRow = {
//   id: number;
//   name: string;
//   addedBy: string;
// };
...
// type Props = {
//   open: boolean;
//   row: OperationSupporterRow | null;
//   onClose: () => void;
//   onSave: (updated: OperationSupporterRow) => void;
//   onDelete: (toDelete: OperationSupporterRow) => void;
// };

// export default function UpdateOperationSupporterDialog({
//   open,
//   row,
//   onClose,
//   onSave,
...
//         Update Operation Supporter
//       </DialogTitle>

//       <DialogContent sx={{ pt: 1.5 }}>
//         <Box sx={{ display: "grid", gridTemplateColumns: { xs: "1fr", md: "1fr 1fr" }, gap: 2 }}>
//           <TextField
//             label="Operation Supporter *"
//             value={name}
...
// export default function OperationSupporterRow({
export default function UpdateOperationSupporterDialog({
  open,
  row,
  onClose,
