...
// /* ---- shared styles (copied from UpdateLicenseModal) ---- */
...
//   onClose: () => void;
//   onSave: (updated: SatelliteLike) => void;
//   onDelete: (satId: string) => void; // kept same signature you already use
// };

// /* ---- options ---- */
// const STATIONS = ["GSN", "BLR", "PA1", "HYDERABAD"];
// const POLS = ["LHCP", "RHCP", "Dual (RH/LH)"];
...
//         }}
//       >
//         {/* same 2-column grid and spacing as license modal */}
//         <Box
//           sx={{
//             display: "grid",
