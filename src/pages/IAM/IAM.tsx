        ...
        {rows.map((r, idx) => (
          ...
          >
            ...
            {columns.map((c) => {
              ...
              return (
                <Box key={String(c.key)} sx={{
                  px: 1.05, py: 1, fontSize: 13, textAlign: c.align ?? "center", color: bodyText as any, whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis", borderRight: `0px solid ${vars.border}`,
                }}
