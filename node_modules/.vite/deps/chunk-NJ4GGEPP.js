...
} from "./chunk-34TVVWQP.js";
import {
  formControlState
} from "./chunk-GQ63KJTC.js";
import {
  getUnit,
  toUnitless
} from "./chunk-3IEABEWP.js";
import {
  ButtonBase_default
} from "./chunk-4BJ2UQGP.js";
import {
  chainPropTypes,
  elementTypeAcceptingRef_default
} from "./chunk-RIYFUEEB.js";
import {
...
import {
  ...
  useForkRef_default,
  useId_default
} from "./chunk-MS22QCRB.js";
import {
  capitalize_default,
  isMuiElement_default,
  memoTheme_default,
  useForkRef
} from "./chunk-CRZOX2RF.js";
import {
  useDefaultProps
} from "./chunk-KF4WYIOE.js";
import {
  composeClasses,
  css,
...
var Divider = React13.forwardRef(function Divider2(inProps, ref) {
  ...
  return (0, import_jsx_runtime11.jsx)(DividerRoot, {
    as: component,
    className: clsx_default(classes.root, className),
    role,
    ref,
...
var ListItemIcon = React21.forwardRef(function ListItemIcon2(inProps, ref) {
  const props = useDefaultProps({
    props: inProps,
    name: "MuiListItemIcon"
  });
...
var Tab = React25.forwardRef(function Tab2(inProps, ref) {
  const props = useDefaultProps({
    props: inProps,
    name: "MuiTab"
  });
  ...
  const icon = iconProp && label && React25.isValidElement(iconProp) ? React25.cloneElement(iconProp, {
    className: clsx_default(classes.icon, iconProp.props.className)
  }) : iconProp;
  ...
  return (0, import_jsx_runtime23.jsxs)(TabRoot, {
    focusRipple: !disableFocusRipple,
    className: clsx_default(classes.root, className),
    ref,
    role: "tab",
    ...
    ...other,
    children: [iconPosition === "top" || iconPosition === "start" ? (0, import_jsx_runtime23.jsxs)(React25.Fragment, {
      children: [icon, label]
    }) : (0, import_jsx_runtime23.jsxs)(React25.Fragment, {
      children: [label, icon]
    }), indicator]
  });
});
true ? Tab.propTypes = {
   ...
   * The icon to display.
   */
  icon: import_prop_types22.default.oneOfType([import_prop_types22.default.element, import_prop_types22.default.string]),
  /**
   * The position of the icon relative to the label.
   * @default 'top'
   */
  iconPosition: import_prop_types22.default.oneOf(["bottom", "end", "start", "top"]),
  /**
   * The label element.
   */
   ...
   * @default false
   */
  wrapped: import_prop_types22.default.bool
} : void 0;
var Tab_default = Tab;
...
var TabScrollButton = React26.forwardRef(function TabScrollButton2(inProps, ref) {
  const props = useDefaultProps({
    props: inProps,
    name: "MuiTabScrollButton"
  });
  ...
  return (0, import_jsx_runtime26.jsx)(TabScrollButtonRoot, {
    component: "div",
    className: clsx_default(classes.root, className),
    ref,
    role: null,
    ...
    children: direction === "left" ? (0, import_jsx_runtime26.jsx)(StartButtonIcon, {
      ...startButtonIconProps
    }) : (0, import_jsx_runtime26.jsx)(EndButtonIcon, {
      ...endButtonIconProps
    })
  });
});
...
var Tabs = React28.forwardRef(function Tabs2(inProps, ref) {
  const props = useDefaultProps({
    props: inProps,
    name: "MuiTabs"
  });
  ...
  const [displayStartScroll, setDisplayStartScroll] = React28.useState(false);
  const [displayEndScroll, setDisplayEndScroll] = React28.useState(false);
  const [updateScrollObserver, setUpdateScrollObserver] = React28.useState(false);
  ...
  const getConditionalElements = () => {
    ...
    conditionalElements2.scrollbarSizeListener = scrollable ? (0, import_jsx_runtime28.jsx)(ScrollbarSlot, {
      ...scrollbarSlotProps,
      onChange: handleScrollbarSizeChange
    }) : null;
    const scrollButtonsActive = displayStartScroll || displayEndScroll;
    const showScrollButtons = scrollable && (scrollButtons === "auto" && scrollButtonsActive || scrollButtons === true);
    conditionalElements2.scrollButtonStart = showScrollButtons ? (0, import_jsx_runtime28.jsx)(ScrollButtonsSlot, {
      direction: isRtl ? "right" : "left",
      onClick: handleStartScrollClick,
      disabled: !displayStartScroll,
      ...scrollButtonSlotProps
    }) : null;
    conditionalElements2.scrollButtonEnd = showScrollButtons ? (0, import_jsx_runtime28.jsx)(ScrollButtonsSlot, {
  ...
  const indicator = (0, import_jsx_runtime28.jsx)(IndicatorSlot, {
    ...indicatorSlotProps
  });
  let childIndex = 0;
  ...
  return (0, import_jsx_runtime28.jsxs)(RootSlot, {
    ...rootSlotProps,
    children: [conditionalElements.scrollButtonStart, conditionalElements.scrollbarSizeListener, (0, import_jsx_runtime28.jsxs)(ScrollerSlot, {
      ...scrollerSlotProps,
      children: [(0, import_jsx_runtime28.jsx)(ListSlot, {
        "aria-label": ariaLabel,
        "aria-labelledby": ariaLabelledBy,
...
true ? Tabs.propTypes = {
  ...
  slotProps: import_prop_types25.default.shape({
    ...
    scrollbar: import_prop_types25.default.oneOfType([import_prop_types25.default.func, import_prop_types25.default.object]),
    scrollButtons: import_prop_types25.default.oneOfType([import_prop_types25.default.func, import_prop_types25.default.object]),
    scroller: import_prop_types25.default.oneOfType([import_prop_types25.default.func, import_prop_types25.default.object]),
  ...
  slots: import_prop_types25.default.shape({
    ...
    scrollbar: import_prop_types25.default.elementType,
    scrollButtons: import_prop_types25.default.elementType,
    scroller: import_prop_types25.default.elementType,
...
var TextField = React29.forwardRef(function TextField2(inProps, ref) {
  ...
  const InputElement = (0, import_jsx_runtime29.jsx)(InputSlot, {
  ...
  return (0, import_jsx_runtime29.jsxs)(RootSlot, {
    ...rootProps,
    children: [label != null && label !== "" && (0, import_jsx_runtime29.jsx)(InputLabelSlot, {
      htmlFor: id,
      id: inputLabelId,
      ...inputLabelProps,
      children: label
    }), select ? (0, import_jsx_runtime29.jsx)(SelectSlot, {
      "aria-describedby": helperTextId,
      id,
      ...
      ...selectProps,
      children
    }) : InputElement, helperText && (0, import_jsx_runtime29.jsx)(FormHelperTextSlot, {
      id: helperTextId,
      ...formHelperTextProps,
      children: helperText
    })]
...
//# sourceMappingURL=chunk-NJ4GGEPP.js.map
