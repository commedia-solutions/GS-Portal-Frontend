...
var Menu = React22.forwardRef(function Menu2(inProps, ref) {
  ...
  let activeItemIndex = -1;
  React22.Children.map(children2, (child, index) => {
...
var SelectInput = React24.forwardRef(function SelectInput2(props, ref) {
  ...
  const childrenArray = React24.Children.toArray(children2);
...
var OutlinedInput = React33.forwardRef(function OutlinedInput2(inProps, ref) {
  ...
  const [NotchedSlot, notchedProps] = useSlot("notchedOutline", {
    ...
    additionalProps: {
      label: label != null && label !== "" && fcs.required ? (0, import_jsx_runtime19.jsxs)(React33.Fragment, {
        children: [label, " ", "*"]
      }) : label
    }
  });
...
var Select = React34.forwardRef(function Select2(inProps, ref) {
  const props = useDefaultProps({
    name: "MuiSelect",
    props: inProps
  });
  ...
  return (0, import_jsx_runtime20.jsx)(React34.Fragment, {
    children: React34.cloneElement(InputComponent, {
...
//# sourceMappingURL=chunk-WGQ5S73A.js.map
